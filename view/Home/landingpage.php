...
<head>
    ...
    <div class="container-fluid" style="position: relative; position: -webkit-sticky; position: sticky; top: 0; z-index: 2; background-color: #DCDCDC; opacity: 0.2;">
      <div class="row" style="padding-bottom: 8px;">
        <div class="col--md-4 col-sm-4 col-xs-4">
         <a href="<?=$site;?>" id="logo">
          <img src="./img/home.png" height="30" width="40" alt="" data-retina="true" class="hidden-xs" style="padding-top:5px">
          <img src="./img/home.png" height="30" width="40" alt="" data-retina="true" class="hidden-lg hidden-md hidden-sm">
        </a>
        </div>
  ...
  background-size: cover; background-repeat: repeat-y; background-image: url('./view/resources/img/mtitecnologia-ciencia-de-dados-1.jpg');">
      <div id="sub_content">
       <h1></h1>
