...
<div style="margin-top: 50px;" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			$domingo = (!empty($config_domingo) && $domingo1[0] == 'on' ? '<center><b>'.$texto['msg_h_dimingo'].'</b> <span style="margin-left:30px">'.$domingo.'</span></center>' : '');
			echo $domingo;
	//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_segunda)):
			...
			$segunda = (!empty($config_segunda) && $segunda1[0] == 'on' ? '<center><b>'.$texto['msg_h_segunda'].'</b> <span style="margin-left:30px">'.$segunda.'</span></center>' : '');
			echo $segunda;
			//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_terca)):
			...
			$terca = (!empty($config_terca) && $terca1[0] == 'on' ? '<center><b>'.$texto['msg_h_terca'].'</b> <span style="margin-left:30px">'.$terca.'</span></center>' : '');
			echo $terca;
			//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_quarta)):
			...
			$quarta = (!empty($config_quarta) && $quarta1[0] == 'on' ? '<center><b>'.$texto['msg_h_quarta'].'</b> <span style="margin-left:30px">'.$quarta.'</span></center>' : '');
			echo $quarta;
			//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_quinta)):
			...
			$quinta = (!empty($config_quinta) && $quinta1[0] == 'on' ? '<center><b>'.$texto['msg_h_quinta'].'</b> <span style="margin-left:30px">'.$quinta.'</span></center>' : '');
			echo $quinta;
			//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_sexta)):
			...
			$sexta = (!empty($config_sexta) && $sexta1[0] == 'on' ? '<center><b>'.$texto['msg_h_sexta'].'</b> <span style="margin-left:30px">'.$sexta.'</span></center>' : '');
			echo $sexta;
			//-----------------------------------------------------------------------------------------------------------------------------
			if(!empty($config_sabado)):
			...
			$sabado = (!empty($config_sabado) && $sabado1[0] == 'on' ? '<center><b>'.$texto['msg_h_sabado'].'</b> <span style="margin-left:30px">'.$sabado.'</span></center>' : '');
			echo $sabado;
			?>
			<br />
			<div class="modal-footer">
