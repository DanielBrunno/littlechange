...
define('USER', 'startu38_s2predp');
define('PASS', 'tOS0ul%E&j3p');
define('DBSA', 'startu38_escolpbest');
...
define('HOME', 'https://startupnatal.com.br/escolasEstaduais/view/Home/'); // SEMPRE COM A BARRA NA FRENTE ---- ---- ---- ----
