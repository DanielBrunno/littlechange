    ...
    <br><hr>
      <?php include "includes/horaUsuarioTop.php"; ?>
        ...
        <section id="corpoView" class="parallax-window" id="short" data-parallax="scroll">
          <div class="col-md-12">	
            <h2 style="text-align: center; font-size:12px; color:#C0C0C0; z-index:-1;">EVOLUÇÃO</h2><hr>
            <div class="col-md-4">  <?php include 'includes/graficoBarras.php'; ?><hr> </div>
            <div class="col-md-4">  <?php include 'includes/graficoPizza.php'; ?><hr> </div>
            <div class="col-md-4">  <?php include 'includes/graficoDoughnut.php'; ?><hr> </div>
          </div>
      </section><!-- End section -->
      <hr>
    </div> 
